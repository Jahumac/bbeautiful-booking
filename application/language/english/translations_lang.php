...
$lang['cancel_appointment_locked_title'] = 'Cancellation window closed';
$lang['cancel_appointment_locked_hint'] = 'Your appointment is within 24 hours of the scheduled time, so you can\'t cancel it online. To cancel, please call or text the salon on {salon_phone} (late cancellations may be charged). You can still reschedule your appointment below — no need to call for that.';
$lang['cancel'] = 'Cancel';
...
$lang['vat_rate'] = 'VAT Rate (%)';
$lang['vat_rate_hint'] = 'Leave at 0% unless you are VAT-registered. Your prices are the final price the customer pays, so when set above 0% the VAT is shown as already included in the total (e.g. at 20%, a £73.00 total shows £12.17 VAT and £60.83 before VAT). Only change this once you are registered for VAT.';
$lang['cancellation_notice_hours'] = 'Late-cancellation notice (hours)';
$lang['cancellation_notice_hours_hint'] = 'Online self-cancellation is blocked within this many hours before the appointment (default 24h). Customers inside the window are told to contact the salon by phone or text.';
